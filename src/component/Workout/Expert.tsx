...
export default function Expert(props: any) {
    ...
    if (!work_out || work_out.length === 0) {
        return (
            <div className="workout-section workout-section-expert" style={{ marginTop: '2rem' }}>
                {[1, 2, 3, 4, 5, 6].map((n) => (
    ...
    return (
        <>
            ...
            {/* Cards grid */}
            <div className="workout-section workout-section-expert">
                    ...
                    <div className="cardwork" key={i}>
                        ...
                        <div className="cardwork-meta">
                            ...
                            <div className="cardwork-meta-item">
                                ...
                                <span className="meta-value difficulty-badge-expert">Expert</span>
                            </div>
                        </div>
                        <div className="cardwork-actions">
